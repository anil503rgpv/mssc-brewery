package com.shiva.msscbrewery.web.controller.v2;

import com.shiva.msscbrewery.web.model.BeerDto;
import com.shiva.msscbrewery.web.model.v2.BeerDtoV2;
import com.shiva.msscbrewery.web.service.v2.BeerServiceV2;
...
public class BeerControllerV2 {
    ...
    public ResponseEntity handlePut(@PathVariable("beerId") UUID beerId, @RequestBody BeerDtoV2 beerDtoV2){
        BeerDtoV2 updateOrCreateDto = beerServiceV2.updateBeer(beerId, beerDtoV2);
